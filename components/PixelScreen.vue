...
<template>
  <div class="p-x-14 p-y-7 grow-1 overflow-hidden">
    <div
      class="text-3xl font-mono p-2px rounded-8px h-full transition-box-shadow overflow-hidden bg-screen-border"
      :class="{
        'shadow-screen-glow-on': !isOff,
        'shadow-screen-glow-off': isOff,
      }"
    >
