...
<template>
  <div class="flex flex-col gap-2 items-center">
    ...
    <button
      type="button"
      class="group border-0.5 border-base-600/80 rounded-6px flex w-18 aspect-ratio-1.6 transition-shadow from-base-200 to-base-300 bg-linear-to-b shadow-btn-base active:shadow-none"
