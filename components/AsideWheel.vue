...
<template>
  ...
  >
    <div class="h-full w-full transform-3d inset-0 absolute">
      <div
        class="h-full w-full transform-3d inset-0 absolute"
      >
        <div
          v-for="i in faces"
          :key="i"
          class="rounded-xs bg-base w-full transform-3d left-0 absolute shadow-wheel-face before:(rounded-inherit op-12 content-empty inset-0 absolute bg-noise)"
          :style="{
